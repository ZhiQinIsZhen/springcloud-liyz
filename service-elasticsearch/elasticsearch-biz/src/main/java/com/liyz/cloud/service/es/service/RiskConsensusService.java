...
import com.liyz.cloud.service.es.repository.RiskConsensusRepository;
...
public class RiskConsensusService {
     ...
     * @return
     */
    public int save(EsRiskConsensusDO riskConsensusDO) {
        List<EsRiskConsensusDO> list = new ArrayList<>();
    ...
    public int save(List<EsRiskConsensusDO> list) {
        ...
        Iterator<EsRiskConsensusDO> iterator = iterable.iterator();
        int count = 0;
     ...
     * @return
     */
    public Page<EsRiskConsensusDO> searchForHighlight(RiskConsensusPageQueryBO queryBO) {
        NativeSearchQueryBuilder builder = getBuilder(queryBO);
        //高亮
